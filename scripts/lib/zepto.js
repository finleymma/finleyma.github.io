...
define(function (a, b, c) {
    ...
    window.Zepto = d, void 0 === window.$ && (window.$ = d), "function" == typeof define && define("zepto-debug", [], function () {
        return d
    }), function (a) {
        function b(a) {
        ...
        var l, m = (a.zepto.qsa, 1), n = Array.prototype.slice, o = a.isFunction, p = function (a) {
        ...
        a.each(p, function (a, c) {
            ...
            return v = function (b) {
                ...
                A = !0,(function(that){setTimeout(function(){ a(that).css(t)},0)})(this), p && p.call(this)
